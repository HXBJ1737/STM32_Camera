...
def init(screen_baudrate=80, pressure=1800,rotation=1):
    ...
    for n in range(0, 4):
        while True:
            ...
            if x_original < 32700 and y_original > 100:
                ...
                img.draw_string(
                    calibration_coordinate[n][0]-4, calibration_coordinate[n][1]-25, str(3-round((millis()-timer)/1000)))
